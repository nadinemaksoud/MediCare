<%@ Page Title="Search – MediCare" Language="C#" MasterPageFile="~/MasterPage/PatientSite.Master"
    AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="MediCare.Pages.Patient.Search" %>
...
<asp:Content ID="PageContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="sea-root">
        ...
        <!-- SEARCH BAR (now uses an asp:Panel for server-side submission) -->
            ...
            <div class="sea-search-panel">
                ...
                <div class="sea-search-field sea-search-field--grow">
                    ...
                    <div class="sea-search-input-wrap">
                        ...
                        <asp:TextBox ID="txtSearchQuery" runat="server" CssClass="sea-search-input"
                            placeholder="Type a name, specialization, description..."></asp:TextBox>
                    </div>
                </div>
        ...
        <!-- Message (server‑side managed) -->
        <asp:Label ID="lblSearchMsg" runat="server" CssClass="sea-inline-msg" Visible="false" />
                ...
                <div class="sea-table-wrap">
                    <asp:GridView ID="gvMedicines" runat="server" CssClass="sea-grid"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <%-- Direct link to AddMedicine page --%>
    ...
    <%-- No external JavaScript needed now --%>
</asp:Content>